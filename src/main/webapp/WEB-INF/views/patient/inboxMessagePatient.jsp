        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="message_for_doctor_p" class="btn btn-primary btn-sm"
					title="Add Message"><i class="fa fa-plus-circle"></i>Doctor
					</a></h3>
					
			<h3 class="box-title"><a href="message_for_nurse_p" class="btn btn-primary btn-sm"
					title="Add Message"><i class="fa fa-plus-circle"></i>Nurse
					</a></h3>
			<h3 class="box-title"><a href="message_for_patient_p" class="btn btn-primary btn-sm"
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="message_update_p?id=${m.id}" >Close</a>
