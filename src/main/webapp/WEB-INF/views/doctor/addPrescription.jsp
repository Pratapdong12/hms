  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i class="fa fa-envelope"></i> Prescription Manager</a></li>
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form role="form" action="add_prescription"  method="POST">
            
             	
             	 <div class="form-group">
	             	 <label><b>Prescription To</b></label>
	             	  <select class="form-control" name="appointmentId" >
											<c:forEach items="${appointment}" var="a">
												<option value="${a.id}">${a.patient.firstName} ${a.patient.lastName} ${a.schedule.scheduleDate}</option>
											</c:forEach>
             	...
             	<div class="form-group">
                    ...
                    <textarea id="editor1" name="prescription" rows="10" cols="80" placeholder="Message ..." required>
