        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="notice_form_d" class="btn btn-primary btn-sm"
								...
								<c:forEach items="${notice}" var="n" varStatus="c">
									<tr>
										...
										<td><a class="btn btn-secondary " title="edit"
											href="edit_notice_d?id=${n.id}"><i class="fa fa-pencil"></i></a>
											<a class="btn btn-danger" title="delete"
											href="#myModal${n.id}" role="button" data-toggle="modal"><i
												class="fa fa-trash"></i></a></td>
										<div id="myModal${n.id}" class="modal fade">
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="notice_delete_d?id=${n.id}" title="Delete"><i
