        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="notice_form" class="btn btn-primary btn-sm"
								...
								<c:forEach items="${notice}" var="n" varStatus="c">
									<tr>
										...
										<td><a class="btn btn-secondary " title="edit"
											href="edit_notice?id=${n.id}"><i class="fa fa-pencil"></i></a>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="notice_delete?id=${n.id}" title="Delete"><i
