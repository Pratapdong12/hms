  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form role="form" action="notice_update"  method="POST">
          <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
             	...
             	<textarea name="noticeDescrition" class="form-control" value="${notice.noticeDescrition}" placeholder="Descrition about Notice ..."></textarea>
             </div>
