    ...
    <section class="content">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form role="form" action="add_message_admin"  method="POST">
             	...
             	<div class="form-group">
             	 ...
             	 <div class="form-group"  >
	             	 <label><b>Send To</b></label>
	             	  <select class="form-control" name="receiver" class="hidden" id="cdoctor" required>
             	...
             	<div class="form-group" class="hidden" id="cpatient">
	             	 <label><b>Send To</b></label>
...
$(document).ready(function(){
	$("#selecte").change(function(){
        ...
        if(selectedValue === 'Doctor') $("#cdoctor").show();
        else $("#cdoctor").hide();
