        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="message_for_doctor" class="btn btn-primary btn-sm"
					title="Add Message"><i class="fa fa-plus-circle"></i>Doctor
					</a></h3>
					
			<h3 class="box-title"><a href="message_for_nurse" class="btn btn-primary btn-sm"
					title="Add Message"><i class="fa fa-plus-circle"></i>Nurse
					</a></h3>
			<h3 class="box-title"><a href="message_for_patient" class="btn btn-primary btn-sm"
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="message_update?id=${m.id}" >Close</a>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="message_delete?id=${m.id}" title="Delete"><i
