								...
								<c:forEach items="${patient}" var="p" varStatus="c">
									<tr>
										...
										<td><a class="btn btn-secondary " title="view"
											href="#viewModal${p.id}" role="button" data-toggle="modal"><i class="fa fa-eye"></i></a>
											<a class="btn btn-success " title="approve"
											href="approve_patient_a?id=${p.id}">Approve</a>
										...
										<div id="viewModal${p.id}" class="modal fade">
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h4 class="modal-title centre"><img alt="pic" src="ImageDisplayPatient?patientId=${p.id}"
											width="70px" height="80px"></h4>
													...
													<div class="modal-body">
														...
														<b>Contact Number: </b>${p.contactNumber}<br>
														<b>Sex: </b>${p.sex}<br>
														<b>DOB: </b>${p.dob}<br>
														<b>Status: </b>${p.status}<br>
														<b>Blood Group: </b>${p.bloodGroup}<br>
													</div>
