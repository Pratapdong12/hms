                 ...
                 <tbody>
						<c:forEach items="${appointment}" var="a" varStatus="c">
									<tr>
										...
										<td><a class="btn btn-primary" title="Accept Booking"
											href="#myModalAccept${a.id}" role="button" data-toggle="modal" >Accept</a>
											...
											width="70px" height="80px"></h4>
													...
													<div class="modal-body">
														...
														<b>Selected Doctor: </b>${a.doctor.firstName} ${a.doctor.lastName}<br>
													</div>
											...
											<div id="myModalAccept${a.id}" class="modal fade">
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
													...
													<div class="modal-body">
														<h4>Do u want to accept this</h4>
													</div>
													<div class="modal-footer">
														<a  href="appointment_accept?id=${a.id}" class="btn btn-primary" >Accept</a>
