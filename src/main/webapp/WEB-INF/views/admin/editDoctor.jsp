  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <form role="form" action="doctor_update"  method="POST"  enctype="multipart/form-data">
            <div class="form-group">
             	...
             	<div class="form-group">
             	 ...
             	 <input type="password" class="form-control" name="password" value="${doctor.password}"  placeholder="Password" readonly="readonly" >
             	</div>
				...
				<input type="radio" name="sex" value="Others" ${doctor.sex=='Others'?'checked':''} placeholder="Others"> Others
             	...
             	<div class="form-group">
             	 ...
             	 <input type="number" class="form-control" name="charge" value="${doctor.charge}" placeholder="Charge" required>
             	</div>
