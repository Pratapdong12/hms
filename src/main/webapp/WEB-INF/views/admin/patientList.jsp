        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="patient_form" class="btn btn-primary btn-sm"
								...
								<c:forEach items="${patient}" var="p" varStatus="c">
									<tr>
										...
										<td><a class="btn btn-success " title="view"
											href="view_patient_a?id=${p.id}" role="button" data-toggle="modal"><i class="fa fa-eye"></i></a>
											<a class="btn btn-primary " title="view"
											href="edit_patient?id=${p.id}"><i class="fa fa-pencil"></i></a>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														...
														<a href="patient_delete?id=${p.id}" title="Delete"><i
